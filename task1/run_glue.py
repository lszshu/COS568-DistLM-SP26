# coding=utf-8
"""Task 1 single-node fine-tuning script."""
...
def train(args, train_dataset, model, tokenizer):
    ...
    for epoch in train_iterator:
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            tr_loss += loss.item()
            if len(first_five_losses) < 5:
                first_five_losses.append(loss.item())
                logger.info("epoch=%d step=%d loss=%.6f", epoch + 1, step + 1, loss.item())
